...
const pgData = [
    {
        ...
        title: "do you ever", //the title of the page (leaving this blank will default it to "Page X")
        date: writeDate(2023,9, 11), //the date on which the page was posted (mainly for the archive). The date is written using a function called "writeDate", basically just put writeDate and then some parenthesis and, comma separated, the year followed by the month and the day. Don't forget another comma at the end outside the parenthesis!
    ...
    },
	{
		pgNum: 2,
        title: "don't try",
        date: writeDate(2023,9,13),
        altText: "",
        imageFiles: "1",
        authorNotes: `<p>no comments for you this time, screw you</p>`
	},
    {
		pgNum: 3,
        title: "egg moment",
        date: writeDate(2023,9,15),
        altText: "",
        imageFiles: "1",
        authorNotes: `<p>there is no metaphor. shut up.</p>`
	}
];
